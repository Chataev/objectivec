...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    //    NSData* studentImage = [self.imageView image];
        ...
        NSString *params = [NSString stringWithFormat:@"first_name=%@&last_name=%@&phone_number=%@&email=%@&photo=%@", firstName, lastName, phoneNumber, email, nil];
        ...
        self.addStudent = [Student initWithName:firstName lastName:lastName email:email phone:phoneNumber image:nil imageData:nil studentID:@""];
