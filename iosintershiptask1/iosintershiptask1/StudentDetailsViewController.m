...
//    self.imageStudent.image = student;
    ...
    //NSData *imageData = UIImagePNGRepresentation(self.student.imageData);
  //  self.imageStudent.image = [UIImage imageWithData:imageData];;

    
    //UIImage *image = [self.student imageWit];
    //NSData *imageData = UIImagePNGRepresentation(self.student.imageData);
    //UIImage *imageFromData = [UIImage imageWithData:self.student.imageData];
   // self.imageStudent.image = imageFromData;
...
- (IBAction)editButton:(UIBarButtonItem *)sender
{
    ...
    if(self.tableView.editing){
       ...
       //
        ...
        UIImage *image = [UIImage imageNamed:@"daria"];
        NSData * imageDataNew = UIImageJPEGRepresentation(image, 1.0f);
        NSData * image = UIIma
...
//NSData *
        ...
        NSString *params = [NSString stringWithFormat:@"id=%@&first_name=%@&last_name=%@&phone_number=%@&email=%@&photo=%@", self.student.studentID, firstName, lastName, phoneNumber, email, imageDataNew];
        ...
        self.editStudent = [Student initWithName:firstName lastName:lastName email:email phone:phoneNumber image:nil imageData:nil studentID:@""];
        NSLog(@"%@ %@ %@ %@", firstName, lastName, email, phoneNumber);
        
        self.imageStudent.image = [UIImage imageWithData:imageDataNew];
